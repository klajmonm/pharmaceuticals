...
- Optimal gas-phase geometries of 12 drugs and drug-like molecules determined using the following approach:
...
- COSMO-SAC sigma-profiles of the above 12 compounds at their optimal gas-phase geometries:
